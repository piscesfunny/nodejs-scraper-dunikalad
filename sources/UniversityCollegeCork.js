...
const listingUrl = 'https://ore.ucc.ie/pls/corerecruit/erq_search_package.search_form?p_company=5023&p_internal_external=E#';
...
const getListings = async (address, searchTerm) => {
  ...
  try {
    ...
    try {
        const company = 'University College Cork'
        const formattedAddress = 'Cork'
